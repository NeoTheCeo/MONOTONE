...
async function TrackSection() {
  try {
    ...
    return (
      <>
        <div className="flex items-center justify-between mb-6">
          <h3 className="font-display text-2xl font-bold">Latest Uploads</h3>
          <span className="text-sm text-text-muted">{tracks.length} tracks</span>
        </div>
        ...
        {tracks.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="font-display text-xl font-bold mb-2">Be the first to upload!</h3>
            <p className="text-text-muted mb-4">Share your African music with the world.</p>
            <a href="/upload" className="btn-primary">Upload Music</a>
          </div>
        ) : (
    ...
    return (
      <div className="text-center py-16">
        <p className="text-text-muted">Unable to connect. Please try again later.</p>
      </div>
    );
  }
}
        ...
        <section className="relative py-16 px-4 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto text-center">
            <h2 className="font-display text-4xl md:text-5xl font-bold mb-4">
              Share <span className="text-primary">African Music</span>
            </h2>
